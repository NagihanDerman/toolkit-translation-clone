    ...
    <div className="bg-zinc-900 h-screen text-white grid place-items-center">
      <div className="w-[80vw] max-w-[1100px] flex flex-col justify-center">
        <h1 className="text-center text-4xl font-semibold mb-7 ">
          Translation <span className="text-green-300">+</span>{" "}
        </h1>
        ...
        <div className="flex gap-2 text-black">
          ...
          <button
            onClick={handleSwap}
            className="rounded py-2 px-6 bg-zinc-700 text-white transition hover:bg-green-300"
          >
            Chance
          </button>
          <Select
        ...
        <button
          ...
          className="rounded-md py-3 px-5 text-[17px] font-semibold cursor-pointer bg-zinc-700 mt-3  hover:bg-green-300 transition"
        >
          Translate
        </button>
      </div>
